...
default_settings = {
    "maintenance": False,
    "autoban": True,
    "max_ip_req": 20, # Etwas erhöht, damit echte User unter Last nicht sofort blockiert werden
    "server_limit": 1000, # Höheres Limit, damit er bei 500+ nicht direkt dichtmacht
    "throttle_delay": 0.0,
        ...
        <div class="card">
            ...
            <div class="tab-content __CONTENT_SEC_ACTIVE__">
                <form action="/admin/update-settings" method="POST">
                    <div style="font-size: 13px; margin-bottom: 5px;">Wartungsmodus:</div>
                    ...
                    <div style="font-size: 13px; margin-bottom: 5px;">Automatischer Bot-Schutz:</div>
                    ...
                    <div style="font-size: 13px; margin-bottom: 5px;">Max. Anfragen pro IP / Sekunde:</div>
                    ...
                    <div style="font-size: 13px; margin-bottom: 5px;">Globales Website-Limit (RPS Schwelle):</div>
...
class FastTrafficHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Schneller IP-Check mit Sets statt teuren Abfragen
        ...
        # Externe GeoIP Abfrage nur bei normalen Seitenaufrufen (nicht bei High-Speed-Spam)
