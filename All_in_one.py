...
<head>
    ...
    <style>
        ...
        .stat-box .val { font-size: 16px; font-weight: bold; color: var(--primary); margin-top: 4px; }
        ...
        .admin-link { display: block; text-align: center; background: #1e293b; color: var(--text); padding: 10px; border-radius: 10px; text-decoration: none; font-size: 12px; font-weight: bold; border: 1px solid var(--border); transition: 0.2s; }
        .admin-link:hover { background: var(--primary); border-color: var(--primary); }
    </style>
</head>
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="stats-grid">
                <div class="stat-box"><div class="lbl">Gesamt Aufrufe</div><div class="val" id="total-req">__TOTAL_REQ__</div></div>
                <div class="stat-box"><div class="lbl">Anfragen / Sek.</div><div class="val" id="current-rps">__CURRENT_RPS__</div></div>
                <div class="stat-box"><div class="lbl">Peak RPS</div><div class="val">__PEAK_RPS__</div></div>
            </div>

            <div class="chart-title"><span>Live Anfragen Verlauf (letzte 30 Sek.)</span><span style="color:var(--success);">● Live aktiv</span></div>
            <div class="chart-container" id="chart">
                __CHART_BARS__
            </div>

            <a href="/admin" class="admin-link">🔐 Zum Admin-Panel wechseln</a>
        </div>
    </div>
    <script>
        // Automatischer Live-Reload alle 2 Sekunden, damit der Graph & die Werte fließend aktualisiert werden
        setTimeout(function(){
...
<head>
    ...
    <style>
        ...
        .back-link { display: block; margin-top: 15px; color: #94a3b8; font-size: 12px; text-decoration: none; }
...
<head>
    ...
    <style>
        ...
        .home-btn { display: block; text-align: center; background: #1e293b; color: var(--text); padding: 10px; border-radius: 10px; text-decoration: none; font-size: 12px; font-weight: bold; border: 1px solid var(--border); margin-bottom: 10px; }
        .home-btn:hover { background: #26334d; }
    </style>
</head>
<body>
    <div class="container">
